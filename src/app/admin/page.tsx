    ...
    <div>
      ...
      <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
        {cardData.map((card) => (
          <div
            key={card.key}
            className={`rounded-xl border border-white/10 bg-gradient-to-br ${card.color} p-6 backdrop-blur-xl`}
          >
      ...
      <div className="mt-10 rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl">
        <h3 className="text-lg font-semibold text-white">파이프라인 상태</h3>
