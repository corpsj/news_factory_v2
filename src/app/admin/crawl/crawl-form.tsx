    ...
    <div className="space-y-6">
      <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl">
        <div className="mb-4 flex items-center justify-between">
          <h3 className="text-sm font-semibold text-zinc-300">기관 선택</h3>
      ...
      <div className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <label htmlFor="crawl-date-from" className="mb-1.5 block text-xs text-zinc-400">
              시작일
            </label>
            <input
              id="crawl-date-from"
              ...
              className="w-full rounded-lg border border-white/10 bg-white/10 px-3 py-2 text-sm text-white focus:border-white/30 focus:outline-none"
            />
          </div>
          <div>
            <label htmlFor="crawl-date-to" className="mb-1.5 block text-xs text-zinc-400">
              종료일
            </label>
            <input
              id="crawl-date-to"
          ...
          <div>
            <label htmlFor="crawl-max-pages" className="mb-1.5 block text-xs text-zinc-400">
              페이지 수 (최대 5)
            </label>
            <input
              id="crawl-max-pages"
          ...
          <div>
            <label htmlFor="crawl-limit-per-site" className="mb-1.5 block text-xs text-zinc-400">
              사이트당 제한
            </label>
            <input
